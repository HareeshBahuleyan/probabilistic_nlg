...
def model_argparse():
    ...
    parser.add_argument("--anneal_till", type=int, default=2300, help='do KL cost annealing till this many iterations')
    ...
    # Output log file
    gl.config_fingerprint = str(config['dataset']) + '_' + str(config['anneal_type']) + \
